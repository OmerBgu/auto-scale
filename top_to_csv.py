...
#  instalation : , on Ubuntu 16.04.2 LTS with python 2.7 newline='' was error but int python 3.6 in my windows it fix the empty line that was made
  #sudo apt-get install python-pip python-dev build-essential #for pip install
  #sudo pip install apscheduler #for installing the scheduler
...
def parse(pod_name):
    ...
    mycsv = csv.writer(open('train.csv', 'a',newline=''))#,newline=''
    ...
    for line in lines:
        if pod_name in line:
            ...
            memory_limits_precent = output[3][2]
...
if __name__ == "__main__":
    ...
    with open('train.csv', 'wt',newline='') as outcsv:  #,newline=''
